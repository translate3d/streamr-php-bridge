...
include_once($_SERVER['DOCUMENT_ROOT']. '/elliptic-php/lib/Curves.php');
include_once($_SERVER['DOCUMENT_ROOT']. '/elliptic-php/lib/HmacDRBG.php');
include_once($_SERVER['DOCUMENT_ROOT']. '/elliptic-php/lib/Utils.php');
include_once($_SERVER['DOCUMENT_ROOT']. '/elliptic-php/lib/EdDSA/KeyPair.php');
include_once($_SERVER['DOCUMENT_ROOT']. '/elliptic-php/lib/EdDSA/Signature.php');
