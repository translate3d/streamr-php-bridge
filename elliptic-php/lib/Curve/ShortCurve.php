...
include_once($_SERVER['DOCUMENT_ROOT']. '/elliptic-php/lib/Curve/BaseCurve.php');
include_once($_SERVER['DOCUMENT_ROOT']. '/elliptic-php/lib/Curve/ShortCurve/Point.php');
include_once($_SERVER['DOCUMENT_ROOT']. '/elliptic-php/lib/Curve/ShortCurve/JPoint.php');
